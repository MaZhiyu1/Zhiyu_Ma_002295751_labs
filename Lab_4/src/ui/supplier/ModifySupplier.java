...
public class ModifySupplier extends javax.swing.JPanel {
    ...
    public ModifySupplier(JPanel workArea, Supplier supplier) {
        initComponents();
        ...
        jTextArea1.setText(supplier.getIntrodu());
    ...
    private void btnAddSupplierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddSupplierActionPerformed
        ...
        supplier.setIntrodu(jTextArea1.getText());
    ...
    private void btnAttachActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAttachActionPerformed
        ...
        if(returnVal == JFileChooser.APPROVE_OPTION){
            ...
            try {
                ...
                Logger.getLogger(ModifySupplier.class.getName()).log(Level.SEVERE, null, ex);
            }
