...
public class ViewProductDetailJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblFeatures1 = new javax.swing.JTable();
        btnAddFeature1 = new javax.swing.JButton();
        ...
        tblFeatures1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null},
                {null, null},
                {null, null},
        ...
        tblFeatures1.setEnabled(false);
        jScrollPane2.setViewportView(tblFeatures1);

        btnAddFeature1.setText("Add Feature");
        btnAddFeature1.setEnabled(false);
        btnAddFeature1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAddFeature1ActionPerformed(evt);
            }
        });

        jLabel1.setFont(new java.awt.Font("Microsoft YaHei UI", 1, 14)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Common Feature");
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        tblFeatures1.setEnabled(true);
        btnAddFeature.setEnabled(true);
        btnAddFeature1.setEnabled(true);
    ...
    private void btnAddFeature1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddFeature1ActionPerformed
        // TODO add your handling code here:
        int row = tblFeatures1.getSelectedRow();
        
        if(row<0) {
            JOptionPane.showMessageDialog(null, "Please select a row from the table first", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
        Feature s = (Feature)tblFeatures1.getValueAt(row, 0);
        Feature newFeature = product.addNewFeature();
    ...
    public void refreshTable() {
        ...
        for(Feature s : product.getFeatures()) {
            Object row[] = new Object[2];
            row[0] = s;
            row[1] = s.getValue() == null? "Empty":s.getValue().toString();
    ...
    private javax.swing.JButton btnAddFeature1;
    ...
    private javax.swing.JTable tblFeatures1;
