...
public class BrowseProductsJPanel extends javax.swing.JPanel {
    ...
    private void btnProductDetailsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProductDetailsActionPerformed
        ...
        if(selectedRow<0) {
            JOptionPane.showMessageDialog(null, "Pls select the product first.", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
    ...
    private void btnModifyQuantityActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModifyQuantityActionPerformed
        ...
        if(selectedRow<0) {
            JOptionPane.showMessageDialog(null, "Pls select the order item first.", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Pls check the price and quantity fields.");
            return;
        }
            int oldQuant = item.getQuantity();
//            System.out.print(item.getQuantity()+" the item.getQuantity");
...
//            System.out.print(item.getProduct().getAvail()+" item.getProduct().getAvail()");
    ...
    private void btnViewOrderItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewOrderItemActionPerformed
        ...
        int selectedRow = tblCart.getSelectedRow();
        if(selectedRow<0) {
            JOptionPane.showMessageDialog(null, "Pls select the item first.", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
        OrderItem item = (OrderItem) tblCart.getValueAt(selectedRow, 0);
    ...
    private void btnAddToCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddToCartActionPerformed
        ...
        if(salesPrice < product.getPrice()){
            JOptionPane.showMessageDialog(null, "Price should be more than it is set in the price.");
            return;
        }
